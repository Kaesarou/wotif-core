...
public class NumberConditionTest {
    ...
    public void testIfZeroIsPositiveThenReturnOne() {
        Integer result = when(0).isPositive().then(t -> 1).end();
        Assertions.assertThat(result).isEqualTo(1);
    }

    @Test
    public void testIfValueIsPositiveThenReturnOne() {
        Integer result = when(1).isPositive().then(t -> 1).end();
        Assertions.assertThat(result).isEqualTo(1);
    }

    @Test
    public void testIfValueIsPositiveThenReturnZero() {
        Integer result = when(-1).isPositive().then(t -> 1)
                .orElse(t -> 0).end();
    ...
    public void testIfValueIsNegativeThenReturnOne() {
        Integer result = when(-1).isNegative().then(t -> 1).end();
        Assertions.assertThat(result).isEqualTo(1);
    }

    @Test
    public void testIfValueIsNegativeThenReturnZero() {
        Integer result = when(1).isNegative().then(t -> 1)
                .orElse(t -> 0).end();
        Assertions.assertThat(result).isEqualTo(0);
    }
    ...
    public void testIfZeroThenReturnOne() {
        Integer result = when(0).isZero().then(t -> 1).end();
        Assertions.assertThat(result).isEqualTo(1);
    }

    @Test
    public void testIfNotZeroThenReturnOne() {
        Integer result = when(1).isDifferentFromZero().then(t -> 1).end();
        Assertions.assertThat(result).isEqualTo(1);
    }

    @Test
    public void testIfNotZeroThenReturnZero() {
        Integer result = when(0).isDifferentFromZero().then(t -> 1)
                .orElse(t -> 0).end();
        Assertions.assertThat(result).isEqualTo(0);
    }
    ...
    public void testIfIsLessThenReturnOne() {
        Integer result = when(5).isLessThen(10).then(t -> 1).end();
        Assertions.assertThat(result).isEqualTo(1);
    }

    @Test
    public void testIfIsLessThenReturnZero() {
        Integer result = when(10).isLessThen(10).then(t -> 1)
                .orElse(t -> 0).end();
        Assertions.assertThat(result).isEqualTo(0);
    }
    ...
    public void testIfIsEqualToThenReturnOne() {
        Integer result = when(10).isEqualTo(10).then(t -> 1).end();
        Assertions.assertThat(result).isEqualTo(1);
    }

    @Test
    public void testIfIsDifferentFromThenReturnZero() {
        Integer result = when(10).isDifferentFrom(10).then(t -> 1)
                .orElse(t -> 0).end();
        Assertions.assertThat(result).isEqualTo(0);
    }
    ...
    public void testIfIsGreaterThenReturnOne() {
        Integer result = when(10).isGreaterThen(5).then(t -> 1).end();
        Assertions.assertThat(result).isEqualTo(1);
    }

    @Test
    public void testIfIsBetween3And9ThenReturnOne() {
        Integer result = when(5).isBetween(3, 9).then(t -> 1).end();
        Integer secondResult = when(3).isBetween(3, 9).then(t -> 1).end();
        Assertions.assertThat(result).isEqualTo(1);
    ...
    public void testIfIsBetween3And9ThenReturnZero() {
        Integer result = when(11).isBetween(3, 9).then(t -> 1)
                .orElse(t -> 0).end();
        Assertions.assertThat(result).isEqualTo(0);
    }
    ...
    public void testIfIsNotBetween3And9ThenReturnOne() {
        Integer result = when(11).isNotBetween(3, 9).then(t -> 1).end();
        Assertions.assertThat(result).isEqualTo(1);
    }

    @Test
    public void testIfIsNotBetween3And9ThenReturnZero() {
        Integer result = when(4).isNotBetween(3, 9).then(t -> 1)
                .orElse(t -> 0).end();
        Assertions.assertThat(result).isEqualTo(0);
    }
    ...
    public void testIfIsStrictlyBetween3And9ThenReturnOne() {
        Integer result = when(5).isStrictlyBetween(3, 9).then(t -> 1).end();
        Assertions.assertThat(result).isEqualTo(1);
    }

    @Test
    public void testIfIsStrictlyBetween3And9ThenReturnZero() {
        Integer result = when(3).isStrictlyBetween(3, 9).then(t -> 1).orElse(t -> 0).end();
        Assertions.assertThat(result).isEqualTo(0);
    ...
    public void testIfIsCloseThenReturnOne() {
        Integer result = when(3.6).isCloseTo(4).then(t -> 1).end();
        Assertions.assertThat(result).isEqualTo(1);
    }

    @Test
    public void testIfIsCloseThenReturnZero() {
        Integer result = when(3.4).isCloseTo(4).then(t -> 1)
                .orElse(t -> 0).end();
        Assertions.assertThat(result).isEqualTo(0);
    }
    ...
    public void testIfIsNotCloseThenReturnOne() {
        Integer result = when(3.4).isNotCloseTo(4).then(t -> 1).end();
        Assertions.assertThat(result).isEqualTo(1);
    }

    @Test
    public void testIfIsNotCloseThenReturnZero() {
        Integer result = when(3.6).isNotCloseTo(4).then(t -> 1)
                .orElse(t -> 0).end();
        Assertions.assertThat(result).isEqualTo(0);
    }
