...
public class IterablesConditionTest {
    ...
    public void testIfArrayContainsThenReturn1() {
        ...
        Integer result = when(arrayToTest).contains('c').then(t ->1).end();
    ...
    public void testIfArrayNotContainsThenReturn1() {
        Character[] arrayToTest = {'a', 'b', 'c'};
        Integer result = when(arrayToTest).doesNotContains('d').then(t ->1).end();
        Assertions.assertThat(result).isEqualTo(1);
    }
    ...
    public void testIfContainsAnyOf() {
        ...
        Integer result1 = when(arrayToTest).containsAnyOf(2, 3).then(t ->1).end();
        Assertions.assertThat(result1).isEqualTo(1);
        Integer result2 = when(arrayToTest).containsAnyOf(1, 6, 9).then(t ->1).end();
        Assertions.assertThat(result2).isEqualTo(1);
        Integer result3 = when(arrayToTest).containsAnyOf(Arrays.asList(5, 6, 7)).then(t ->1)
                .orElse(t ->0).end();
    ...
    public void testIfContainsOnly() {
        Integer[] arrayToTest = {1, 2, 3, 4};
        Integer result1 = when(arrayToTest).containsOnly(1, 2, 3, 4).then(t ->1).end();
        Assertions.assertThat(result1).isEqualTo(1);
    ...
    public void testIfNotContainsOnly() {
        Integer[] arrayToTest = {1, 2, 3, 4};
        Integer result1 = when(arrayToTest).doesNotContainsOnly(1, 2, 3).then(t ->1).end();
        Assertions.assertThat(result1).isEqualTo(1);
    ...
    public void testIfContainsOnlyOnce() {
        ...
        Integer result1 = when(arrayToTest).containsOnlyOnce(1, 2, 3).then(t ->1).end();
        Assertions.assertThat(result1).isEqualTo(1);
    ...
    public void testIfContainsMoreThanOnce() {
        Integer[] arrayToTest = {1, 2, 3, 4, 4};
        Integer result1 = when(arrayToTest).containsMoreThanOnce(4).then(t ->1).end();
        Assertions.assertThat(result1).isEqualTo(1);
    ...
    public void testIfStartWith() {
        Integer[] arrayToTest = {1, 2, 3, 4, 4};
        Integer result1 = when(arrayToTest).startsWith(1).then(t ->1).end();
        Assertions.assertThat(result1).isEqualTo(1);
        Integer result2 = when(arrayToTest).startsWith(2).then(t ->1)
                .orElse(t ->0).end();
        Assertions.assertThat(result2).isEqualTo(0);
    }
    ...
    public void testIfEndWith() {
        Integer[] arrayToTest = {1, 2, 3, 4};
        Integer result1 = when(arrayToTest).endsWith(4).then(t ->1).end();
        Assertions.assertThat(result1).isEqualTo(1);
        Integer result2 = when(arrayToTest).endsWith(2).then(t ->1)
                .orElse(t ->0).end();
        Assertions.assertThat(result2).isEqualTo(0);
    }
    ...
    public void testIfIsSubset() {
        ...
        Integer result1 = when(arrayToTest).isSubsetOf(1, 2, 3, 4, 5, 6).then(t ->1).end();
        Assertions.assertThat(result1).isEqualTo(1);
        Integer result2 = when(arrayToTest).isSubsetOf(1, 2, 3, 4).then(t ->1)
                .orElse(t ->0).end();
        Assertions.assertThat(result2).isEqualTo(0);
    }
    ...
    public void testIfIsEmpty() {
        ...
        Integer result1 = when(arrayToTest1).isEmpty().then(t ->1).end();
        Assertions.assertThat(result1).isEqualTo(1);
        Integer[] arrayToTest2 = {1, 2, 3, 4, 5};
        Integer result2 = when(arrayToTest2).isEmpty().then(t ->1)
                .orElse(t ->0).end();
        Assertions.assertThat(result2).isEqualTo(0);
    }
    ...
    public void testIfHasAnyElementsOfTypes() {
        ...
        Assertions.assertThat(result1).isEqualTo(1);
        Integer[] arrayToTest2 = {1, 2, 3, 4, 5};
        Integer result2 = when(arrayToTest2).hasAnyElementsOfTypes(Character.class).then(t ->1)
                .orElse(t ->0).end();
        Assertions.assertThat(result2).isEqualTo(0);
    }
    ...
    public void testIfDoesNotHasAnyElementsOfTypes() {
        ...
        Assertions.assertThat(result1).isEqualTo(1);
        Integer[] arrayToTest2 = {1, 2, 3, 4, 5};
        Integer result2 = when(arrayToTest2).doesNotHasAnyElementsOfTypes(Character.class, Integer.class).then(t ->1)
                .orElse(t ->0).end();
        Assertions.assertThat(result2).isEqualTo(0);
    }
    ...
    public void testIfContainsNull() {
        ...
        Integer result1 = when(arrayToTest1).containsNull().then(t ->1).end();
        Assertions.assertThat(result1).isEqualTo(1);
        Integer[] arrayToTest2 = {1, 2, 3, 4, 5};
        Integer result2 = when(arrayToTest2).containsNull().then(t ->1)
                .orElse(t ->0).end();
        Assertions.assertThat(result2).isEqualTo(0);
    }
    ...
    public void testIfDoesNotContainsNull() {
        ...
        Integer result1 = when(arrayToTest1).doesNotContainsNull().then(t ->1).end();
        Assertions.assertThat(result1).isEqualTo(1);
        Integer[] arrayToTest2 = {1, 2, 3, 4, null};
        Integer result2 = when(arrayToTest2).doesNotContainsNull().then(t ->1)
                .orElse(t ->0).end();
        Assertions.assertThat(result2).isEqualTo(0);
    }
    ...
    public void testIfContainsOnlyNull() {
        ...
        Integer result1 = when(arrayToTest1).containsOnlyNull().then(t ->1).end();
        Assertions.assertThat(result1).isEqualTo(1);
        Integer[] arrayToTest2 = {1, 2, 3, 4, null};
        Integer result2 = when(arrayToTest2).containsOnlyNull().then(t ->1)
                .orElse(t ->0).end();
        Assertions.assertThat(result2).isEqualTo(0);
    }
    ...
    public void testIfDoesNotContainsOnlyNull() {
        ...
        Integer result1 = when(arrayToTest1).doesNotContainsOnlyNull().then(t ->1).end();
        Assertions.assertThat(result1).isEqualTo(1);
        Integer[] arrayToTest2 = {null, null, null, null};
        Integer result2 = when(arrayToTest2).doesNotContainsOnlyNull().then(t ->1)
                .orElse(t ->0).end();
        Assertions.assertThat(result2).isEqualTo(0);
    }
    ...
    public void testIfContainsDuplicate() {
        ...
        Integer result1 = when(arrayToTest1).hasDuplicate().then(t ->1).end();
        Assertions.assertThat(result1).isEqualTo(1);
        Integer[] arrayToTest2 = {1, 2, 3, null};
        Integer result2 = when(arrayToTest2).hasDuplicate().then(t ->1)
                .orElse(t ->0).end();
        Assertions.assertThat(result2).isEqualTo(0);
    }
    ...
    public void testIfNotContainsDuplicate() {
        Integer[] arrayToTest1 = {1, 2, 3, 4};
        Integer result1 = when(arrayToTest1).doesNotHasDuplicate().then(t ->1).end();
        Assertions.assertThat(result1).isEqualTo(1);
        Integer[] arrayToTest2 = {1, null, 3, null};
        Integer result2 = when(arrayToTest2).doesNotHasDuplicate().then(t ->1)
                .orElse(t ->0).end();
        Assertions.assertThat(result2).isEqualTo(0);
    }
    ...
    public void testHasSameSizeAs() {
        Integer[] arrayToTest1 = {1, 2, 3, 4};
        Integer[] arrayToTest2 = {1, null, 3, null};
        Integer result1 = when(arrayToTest1).hasSameSizeAs(arrayToTest2).then(t ->1).end();
        Assertions.assertThat(result1).isEqualTo(1);
        Integer[] arrayToTest3 = {1, 2, 3, 4};
        Integer[] arrayToTest4 = {1, null, 3};
        Integer result2 = when(arrayToTest3).hasSameSizeAs(arrayToTest4).then(t ->1)
                .orElse(t ->0).end();
        Assertions.assertThat(result2).isEqualTo(0);
    ...
    public void testIfIntArrayContains() {
        ...
        int comparator = 1;
        Integer result2 = when(arrayToTest2).contains(comparator).then(t ->1)
                .orElse(t ->0).end();
        Assertions.assertThat(result2).isEqualTo(1);
    }
    ...
    public void testIfCharArrayContains() {
        ...
        Integer result1 = when(arrayToTest1).contains('a').then(t ->1).end();
        Assertions.assertThat(result1).isEqualTo(1);
        char[] arrayToTest2 = {'a', 'b', 'c', 'd'};
        Integer result2 = when(arrayToTest2).contains('e').then(t ->1)
                .orElse(t ->0).end();
        Assertions.assertThat(result2).isEqualTo(0);
    }
